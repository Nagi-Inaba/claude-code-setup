...
| 模型 | 提示词 |
|------|--------|
| Codex | `C:/Users/nagii/.claude/.ccg/prompts/codex/optimizer.md` |
| Gemini | `C:/Users/nagii/.claude/.ccg/prompts/gemini/optimizer.md` |
...
1. **Codex 后端分析**：`Bash({ command: "...--backend codex...", run_in_background: true })`
   - ROLE_FILE: `C:/Users/nagii/.claude/.ccg/prompts/codex/optimizer.md`
   - 需求：分析后端性能问题（$ARGUMENTS）
   - OUTPUT：性能瓶颈列表、优化方案、预期收益

2. **Gemini 前端分析**：`Bash({ command: "...--backend gemini...", run_in_background: true })`
   - ROLE_FILE: `C:/Users/nagii/.claude/.ccg/prompts/gemini/optimizer.md`
