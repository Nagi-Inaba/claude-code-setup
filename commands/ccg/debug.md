...
**Codex 后端诊断**：
```bash
C:/Users/nagii/.claude/bin/codeagent-wrapper.exe --progress --backend codex - "$(pwd)" <<'EOF'
ROLE_FILE: C:/Users/nagii/.claude/.ccg/prompts/codex/debugger.md
<TASK>
需求：<增强后的需求>
上下文：<错误日志、堆栈信息、复现步骤>
</TASK>
...
**Gemini 前端诊断**：
```bash
C:/Users/nagii/.claude/bin/codeagent-wrapper.exe --progress --backend gemini --gemini-model gemini-3.1-pro-preview - "$(pwd)" <<'EOF'
ROLE_FILE: C:/Users/nagii/.claude/.ccg/prompts/gemini/debugger.md
<TASK>
需求：<增强后的需求>
上下文：<错误日志、堆栈信息、复现步骤>
</TASK>
...
| 模型 | 提示词 |
|------|--------|
| Codex | `C:/Users/nagii/.claude/.ccg/prompts/codex/debugger.md` |
| Gemini | `C:/Users/nagii/.claude/.ccg/prompts/gemini/debugger.md` |
