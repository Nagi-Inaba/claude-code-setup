...
# 新会话调用
Bash({
  command: "C:/Users/nagii/.claude/bin/codeagent-wrapper.exe --progress --backend <codex|gemini> {{GEMINI_MODEL_FLAG}}- \"{{WORKDIR}}\" <<'EOF'
ROLE_FILE: <角色提示词路径>
<TASK>
...
# 复用会话调用
Bash({
  command: "C:/Users/nagii/.claude/bin/codeagent-wrapper.exe --progress --backend <codex|gemini> {{GEMINI_MODEL_FLAG}}resume <SESSION_ID> - \"{{WORKDIR}}\" <<'EOF'
ROLE_FILE: <角色提示词路径>
<TASK>
需求：<增强后的需求（如未增强则用 $ARGUMENTS）>
上下文：<前序阶段收集的项目上下文、计划文件内容等>
...
| 阶段 | Codex | Gemini |
|------|-------|--------|
| 分析 | `C:/Users/nagii/.claude/.ccg/prompts/codex/analyzer.md` | `C:/Users/nagii/.claude/.ccg/prompts/gemini/analyzer.md` |
| 规划 | `C:/Users/nagii/.claude/.ccg/prompts/codex/architect.md` | `C:/Users/nagii/.claude/.ccg/prompts/gemini/architect.md` |
| 实施 | `C:/Users/nagii/.claude/.ccg/prompts/codex/architect.md` | `C:/Users/nagii/.claude/.ccg/prompts/gemini/frontend.md` |
...
```
执行 agent: C:/Users/nagii/.claude/agents/ccg/ui-ux-designer.md
输入: 项目上下文 + 用户需求 + 技术栈
输出: UI/UX 设计方案
```
...
```
执行 agent: C:/Users/nagii/.claude/agents/ccg/planner.md
