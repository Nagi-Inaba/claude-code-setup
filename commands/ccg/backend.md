...
# 新会话调用
Bash({
  command: "C:/Users/nagii/.claude/bin/codeagent-wrapper.exe --progress --backend codex - \"{{WORKDIR}}\" <<'EOF'
ROLE_FILE: <角色提示词路径>
<TASK>
...
# 复用会话调用
Bash({
  command: "C:/Users/nagii/.claude/bin/codeagent-wrapper.exe --progress --backend codex resume <SESSION_ID> - \"{{WORKDIR}}\" <<'EOF'
ROLE_FILE: <角色提示词路径>
<TASK>
需求：<增强后的需求（如未增强则用 $ARGUMENTS）>
上下文：<前序阶段收集的项目上下文、分析结果等>
...
| 阶段 | Codex |
|------|-------|
| 分析 | `C:/Users/nagii/.claude/.ccg/prompts/codex/analyzer.md` |
| 规划 | `C:/Users/nagii/.claude/.ccg/prompts/codex/architect.md` |
| 审查 | `C:/Users/nagii/.claude/.ccg/prompts/codex/reviewer.md` |
