...
When working in a project, automatically invoke the corresponding quality gate skills based on the scenario below. These skills are installed at `C:/Users/nagii/.claude/skills/ccg/` and can be called directly.
...
When a task involves 3+ independent files/modules or 2+ parallel workflows, refer to the multi-agent orchestration skill at `C:/Users/nagii/.claude/skills/ccg/orchestration/multi-agent/SKILL.md` for:
