...
- **エージェント** (`~/.claude/agents/`): 25種 — 実装(frontend/backend/infra/mobile-engineer, ui-designer) + 品質(code-reviewer, security-reviewer等) + 計画(planner, architect) + 運用(env-doctor等)
